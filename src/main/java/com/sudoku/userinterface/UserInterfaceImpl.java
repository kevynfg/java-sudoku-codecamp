...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private void styleSudokyTitle(SudokuTextField title, int x, int y) {
    ...
    @Override
    public void updateSquare(int row, int column, int input) {
        SudokuTextField title = textFieldCoordinates.get(new Coordinates(row, column));
